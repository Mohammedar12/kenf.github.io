(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\Users\ِAcer\Desktop\k\kenfAdmin-main\src\main.ts */
      "zUnb");
      /***/
    },
        ...
        _createClass(ScrollspyDirective, [{
          ...
          value: function onScroll(event) {
            ...
            var _loop = function _loop(i) {
              ...
              if (_this5.spiedTags.some(function (spiedTag) {
        ...
        _createClass(HorizontaltopbarComponent, [{
          ...
          value: function ngOnInit() {
            ...
            var val = this.listLang.filter(function (x) {
              return x.lang === _this7.cookieValue;
            });
          ...
          value: function activateMenu() {
            ...
            var resetParent = function resetParent(el) {
              ...
              if (parent) {
                ...
                _this8._removeAllClass('mm-active');

                _this8._removeAllClass('mm-show');
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _core_helpers_error_interceptor__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        ...
        providers: [{
          ...
          provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"],
          useClass: _core_helpers_error_interceptor__WEBPACK_IMPORTED_MODULE_17__["ErrorInterceptor"],
          multi: true
        }, {
          provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"],
        ...
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_15__["TranslateModule"].forRoot({
          loader: {
            provide: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_15__["TranslateLoader"],
            useFactory: createTranslateLoader,
            deps: [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]]
          }
        }), _layouts_layouts_module__WEBPACK_IMPORTED_MODULE_10__["LayoutsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_11__["AppRoutingModule"], _extrapages_extrapages_module__WEBPACK_IMPORTED_MODULE_9__["ExtrapagesModule"], ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_6__["CarouselModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbAccordionModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbNavModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbTooltipModule"], _cyptolanding_shared_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"], _nicky_lenaers_ngx_scroll_to__WEBPACK_IMPORTED_MODULE_7__["ScrollToModule"].forRoot()]]
      });
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AppModule, {
          ...
          imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_15__["TranslateModule"], _layouts_layouts_module__WEBPACK_IMPORTED_MODULE_10__["LayoutsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_11__["AppRoutingModule"], _extrapages_extrapages_module__WEBPACK_IMPORTED_MODULE_9__["ExtrapagesModule"], ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_6__["CarouselModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbAccordionModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbNavModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbTooltipModule"], _cyptolanding_shared_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"], _nicky_lenaers_ngx_scroll_to__WEBPACK_IMPORTED_MODULE_7__["ScrollToModule"]]
        });
      })();
      /*@__PURE__*/
        ...
        _createClass(SidebarComponent, [{
          ...
          value: function ngOnChanges() {
            ...
            if (!this.isCondensed && this.sideMenu || this.isCondensed) {
              setTimeout(function () {
                _this10.menu = new metismenujs_dist_metismenujs__WEBPACK_IMPORTED_MODULE_1___default.a(_this10.sideMenu.nativeElement);
              });
            } else if (this.menu) {
              this.menu.dispose();
            }
          ...
          this.registerUser = function (email, password) {
            return new Promise(function (resolve, reject) {
              firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].auth().createUserWithEmailAndPassword(email, password).then(function (user) {
                ...
                reject(_this11._handleError(error));
              });
            });
          };
          /**
        ...
        _createClass(CyptolandingComponent, [{
          ...
          value: function ngOnInit() {
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["interval"])(3000).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (x) {
              _this12._diff = Date.parse(_this12._trialEndsAt) - Date.parse(new Date().toString());
            })).subscribe(function (x) {
              _this12._days = _this12.getDays(_this12._diff);
              _this12._hours = _this12.getHours(_this12._diff);
              _this12._minutes = _this12.getMinutes(_this12._diff);
              _this12._seconds = _this12.getSeconds(_this12._diff);
            });
          }
        }, {
          key: "getDays",
      ...
      var TopbarComponent = /*#__PURE__*/function () {
        ...
        _createClass(TopbarComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.cookieValue = this._cookiesService.get('lang');
            var val = this.listLang.filter(function (x) {
              return x.lang === _this13.cookieValue;
            });
            this.countryName = val.map(function (element) {
              return element.text;
            });
